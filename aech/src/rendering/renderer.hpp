...
public:
    ...
    auto bake_probes() const noexcept -> void;
    auto update() noexcept -> void;

    [[nodiscard]] auto render_cache() noexcept -> render_cache_t *;
    [[nodiscard]] auto ssao() const noexcept -> bool;
    [[nodiscard]] auto ssao_texture() const noexcept -> const texture_t *;
    [[nodiscard]] auto shadows() const noexcept -> bool;
    [[nodiscard]] auto options() const noexcept -> bool;
    [[nodiscard]] auto poisson_sampling_distance() const noexcept -> float;
    auto               set_options(bool gui) noexcept -> void;

    [[nodiscard]] static auto sort_front_to_back(entity_t a, entity_t b) noexcept -> bool;
    [[nodiscard]] static auto sort_back_to_front(entity_t a, entity_t b) noexcept -> bool;
...
private:
    ...
    std::shared_ptr<directional_light_renderer_t>  m_directional_light_renderer{};
    ...
    auto render_ssao() noexcept -> void;
    auto render_gui() noexcept -> void;
    auto post_process() noexcept -> void;
};
} // namespace aech::graphics
