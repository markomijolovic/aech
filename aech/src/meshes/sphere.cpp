...
// TODO(Marko): calculate tangents and bitangents
aech::graphics::sphere_t::sphere_t(const std::uint32_t sectors, const std::uint32_t stacks) noexcept
{
    ...
    //std::unordered_map<std::uint32_t, std::uint32_t> counts_per_vertex{};
    ...
    //for (std::uint32_t i = 0; i < m_tangents.size(); i++)
    //{
