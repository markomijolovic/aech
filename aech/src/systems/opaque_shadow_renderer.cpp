...
opaque_shadow_renderer_t::opaque_shadow_renderer_t(render_cache_t *render_cache, directional_light_t *dirlight) noexcept
    : m_dirlight{dirlight}
    , m_render_cache{render_cache}
{
}

auto opaque_shadow_renderer_t::render_target() const noexcept -> framebuffer_t *
{
    return m_render_target;
}

auto opaque_shadow_renderer_t::update() noexcept -> void
{
