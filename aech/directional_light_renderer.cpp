...
auto aech::graphics::directional_light_renderer_t::update() const -> void
{
...
auto aech::graphics::directional_light_renderer_t::render_target() const -> aech::graphics::framebuffer_t *
{
    return m_render_target;
}

auto aech::graphics::directional_light_renderer_t::mesh_filter() const -> aech::graphics::mesh_filter_t
{
