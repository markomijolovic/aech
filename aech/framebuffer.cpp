...
auto framebuffer_t::id() const -> std::uint32_t
{
    return m_id;
}

auto framebuffer_t::width() const -> std::uint32_t
{
    return m_width;
}

auto framebuffer_t::height() const -> std::uint32_t
{
    return m_height;
}

auto framebuffer_t::colour_attachments() const -> const std::vector<texture_t> &
{
    return m_colour_attachments;
}

auto framebuffer_t::depth_and_stencil() const -> const texture_t *
{
...
auto framebuffer_t::bind() const -> void
{
    glBindFramebuffer(GL_FRAMEBUFFER, m_id);
}

auto framebuffer_t::unbind() -> void
{
    glBindFramebuffer(GL_FRAMEBUFFER, 0);
}
} // namespace aech::graphics
