...
auto opaque_renderer_t::render_target() const -> framebuffer_t *
{
    return m_render_target;
}

auto opaque_renderer_t::draw_skybox() const -> void
{
...
auto opaque_renderer_t::update() -> void
{
    setup_g_buffer();
...
auto opaque_renderer_t::setup_g_buffer() const -> void
{
...
auto opaque_renderer_t::draw_entity(entity_t entity) const -> void
{
