...
public:
    ...
    auto        set_depth_func(depth_func func) -> void;
    auto        set_blend(bool enable) -> void;
    auto        set_blend(blend_func source, blend_func dest) -> void;
    auto        set_cull(bool enable) -> void;
    auto        set_cull_face(cull_face face) -> void;
    auto        set_shader(shader_t *shader) -> void;
    auto        set_viewport(std::uint32_t x, std::uint32_t y, std::uint32_t width, std::uint32_t height) -> void;
    static auto clear(clear bit) -> void;
