...
public:
    ...
    [[nodiscard]] auto specular_material() const -> material_t *;
    [[nodiscard]] auto diffuse_material() const -> material_t *;
    [[nodiscard]] auto render_target() const -> framebuffer_t *;

    auto add_probe(reflection_probe_t &&probe) -> void;
    auto add_probe(const reflection_probe_t &probe) -> void;
    auto add_probe(light_probe_t &&probe) -> void;
    auto add_probe(const light_probe_t &probe) -> void;
