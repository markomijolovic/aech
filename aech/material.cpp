...
auto material_t::get_textures() const -> const std::unordered_map<std::string, std::pair<const texture_t *, std::uint32_t>> &
{
    return m_textures;
}

auto material_t::get_texture(const std::string &name) -> const texture_t *
{
...
auto material_t::get_texture_cube(const std::string &name) -> const texture_cube_t *
{
...
auto material_t::shader() const -> shader_t *
{
    return m_shader;
}

auto material_t::type() const -> material_t::material_type
{
    return m_type;
}

auto material_t::set_texture(const std::string &name, const texture_t *texture, std::uint32_t unit) -> void
{
    m_textures[name] = {texture, unit};
}

auto material_t::set_texture_cube(const std::string &name, const texture_cube_t *texture, std::uint32_t unit) -> void
{
    m_texture_cubes[name] = {texture, unit};
}

auto material_t::set_uniforms() const -> void
{
    m_shader->use();
