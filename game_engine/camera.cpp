...
namespace aech
{
	math::mat4_t camera_t::make_perspective_projection(float fov, float near_clip, float far_clip, unsigned int view_width, unsigned int view_height)
	{
		auto z_clip_bias0 =
			(far_clip + near_clip)
			/ (far_clip - near_clip);
