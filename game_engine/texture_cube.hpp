...
namespace aech::graphics
{
	...
	public:
		...
		texture_cube_t(uint32_t width, uint32_t height, texture_types::sized_internal_format sif = texture_types::sized_internal_format::rgba8, texture_types::format f = texture_types::format::rgba, texture_types::type t = texture_types::type::ubyte, bool mipmap = true , texture_types::filtering min = texture_types::filtering::linear, texture_types::filtering mag = texture_types::filtering::linear);
